...
# one_hot = True -> see explanation of one hot
mnist = input_data.read_data_sets("mnist_data/", one_hot=True)

# For this example, only 5000 images are used
training_digits, training_labels = mnist.train.next_batch(5000)
# 200 images form a test dataset
test_digits, test_labels = mnist.test.next_batch(2000)

# Placeholders for all images in the dataset -> every image is 28x28S
# This one is for the list of images
...
with tf.Session() as sess:
    ...
    print("Done!")
    # Prints the accuracy of our algorithm
