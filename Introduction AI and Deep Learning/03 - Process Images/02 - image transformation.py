...
original_image_list = ["./imagesTrf/ba.jpeg", "./imagesTrf/gerrit.jpg", "./imagesTrf/goat.jpg"]
...
with tf.Session() as sess:
    ...
    # Write image summary
    summary_writer = tf.summary.FileWriter('./imgCor', graph=sess.graph)

    # Write out all the images in one go
    summary_str = sess.run(tf.summary.image("imagesTrf", images_tensor))
